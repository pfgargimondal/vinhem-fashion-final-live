                ...
                <div className="col-lg-9">
                  <div className="idasijhdmsiejr d-flex align-items-center">
                    ...
                    <div className="doewnkrhwer">
                        <input type="checkbox" className="d-none" id="huidweujr" checked/>
                        
                        <label htmlFor="huidweujr" className="btn btn-main me-1"><i class="bi me-1 bi-plus-circle-dotted"></i> New</label>                        
                    </div>
